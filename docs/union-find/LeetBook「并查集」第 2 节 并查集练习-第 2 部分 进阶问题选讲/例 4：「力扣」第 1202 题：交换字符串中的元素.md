...
![image.png](https://pic.leetcode-cn.com/1610274898-IetqIU-image.png)

**第 3 步**：分组排序。即对同属于一个连通分量中的字符进行排序。

![image.png](https://pic.leetcode-cn.com/1610275111-XqCSVx-image.png)
