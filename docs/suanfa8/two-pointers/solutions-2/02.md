...
使用双指针的原因是根据这个问题的特点，存水的高度取决于两边较短的那个内壁的高度。使用指针对撞的方式不会错过最优解。
...
作者：liweiwei1419
链接：https://suanfa8.com/two-pointers/solutions-2/0011-container-with-most-water
来源：算法吧
